  Aquest és un joc d'estratègia on et converteixes en l'enginyer d'un equip de Fórmula 1. 
  A diferència dels jocs tradicionals on condueixes el cotxe amb un volant o fletxes en temps real, 
  aquí el cotxe es mou segons les ordres numèriques que tu li dones mentre el joc està parat.
...
- La barra d'espai és clau
  ...
  Has de prémer la barra d'Espai del teu teclat en el moment precís per tornar a pausar el joc, canviar els números de direcció i traçar la següent corba.
...
- Sistema d'ajuda
  ...
  Si en un circuit s'et resisteix la victòria i caus eliminat 3 vegades seguides, el joc s'encomanarà d'ajudar-te activant un botó especial de pista.
  Si el prems, apareixerà un cotxe fantasma semitransparent controlat per la intel·ligència artificial del joc.
  Aquest cotxe farà la volta ell sol davant teu per ensenyar-te quina és la línia perfecta que has de seguir i on has d'aplicar les frenades per superar el nivell.
